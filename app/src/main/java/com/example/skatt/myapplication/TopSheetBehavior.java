...
public class TopSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    /**
     * Callback for monitoring events about menu sheets.
     */
    public abstract static class TopSheetCallback {

        /**
         * Called when the menu sheet changes its state.
         *
         * @param bottomSheet The menu sheet view.
        ...
        /**
         * Called when the menu sheet is being dragged.
         *
         * @param bottomSheet The menu sheet view.
         * @param slideOffset The new offset of this menu sheet within its range, from 0 to 1
    ...
    /**
     * The menu sheet is dragging.
     */
    public static final int STATE_DRAGGING = 1;

    /**
     * The menu sheet is settling.
     */
    public static final int STATE_SETTLING = 2;

    /**
     * The menu sheet is expanded.
     */
    public static final int STATE_EXPANDED = 3;

    /**
     * The menu sheet is collapsed.
     */
    public static final int STATE_COLLAPSED = 4;

    /**
     * The menu sheet is hidden.
     */
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, V child, MotionEvent event) {
        ...
        // We have to handle cases that the ViewDragHelper does not capture the menu sheet because
    ...
    public boolean onTouchEvent(CoordinatorLayout parent, V child, MotionEvent event) {
        ...
        // to capture the menu sheet in case it is not captured and the touch slop is passed.
    ...
    /**
     * Sets the height of the menu sheet when it is collapsed.
     *
     * @param peekHeight The height of the collapsed menu sheet in pixels.
...
//        mMaxOffset = mParentHeight - peekHeight;
    ...
    /**
     * Gets the height of the menu sheet when it is collapsed.
     *
     * @return The height of the collapsed menu sheet.
    ...
    /**
     * Sets whether this menu sheet can hide when it is swiped down.
     *
     * @param hideable {@code true} to make this menu sheet hideable.
    ...
    /**
     * Gets whether this menu sheet can hide when it is swiped down.
     *
     * @return {@code true} if this menu sheet can hide.
     * @attr ref android.support.design.R.styleable#BottomSheetBehavior_Layout_behavior_hideable
     */
    ...
    /**
     * Sets whether this menu sheet should skip the collapsed state when it is being hidden
     * after it is expanded once. Setting this to true has no effect unless the sheet is hideable.
     *
     * @param skipCollapsed True if the menu sheet should skip the collapsed state.
     ...
     *
     * @return Whether the menu sheet should skip the collapsed state.
     * @attr ref android.support.design.R.styleable#BottomSheetBehavior_Layout_behavior_skipCollapsed
     */
    ...
    /**
     * Sets a callback to be notified of menu sheet events.
     *
     * @param callback The callback to notify when menu sheet events occur.
     */
    ...
    /**
     * Sets the state of the menu sheet. The menu sheet will transition to that state with
     * animation.
     *
    ...
    /**
     * Gets the current state of the menu sheet.
     *
